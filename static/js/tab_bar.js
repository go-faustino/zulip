...
exports.set_max_width_of_descriptions = function ()  {
    ...
    if (filter.has_operator("stream")) {
        ...
        var narrow_description_actual_width = $(".narrow_description").css("width").slice(0, -2);
        if (narrow_description_actual_width > narrow_description_max_width) {
            var sub = filter.operands("stream")[0];
            var current_stream  = stream_data.get_sub_by_name(sub);
